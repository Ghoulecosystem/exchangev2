...
import { CustomButton, CustomButtonMenu } from 'views/Swap/styles'
  ...
  return (
    <>
      ...
      >
        ...
        <Box>
          <CustomButtonMenu activeIndex={timeWindow} onItemClick={setTimeWindow} scale="sm">
            <CustomButton>{t('24H')}</CustomButton>
            <CustomButton>{t('1W')}</CustomButton>
            <CustomButton>{t('1M')}</CustomButton>
            <CustomButton>{t('1Y')}</CustomButton>
          </CustomButtonMenu>
        </Box>
      </Flex>
