...
import { CustomButton, CustomButton2, CustomButtonCancel } from 'views/Swap/styles'
...
const ExpertModal: React.FC<ExpertModalProps> = ({ setShowConfirmExpertModal, setShowExpertModeAcknowledgement }) => {
  ...
  return (
    <Modal
      ...
      style={{ maxWidth: '360px', background: 'black', borderRadius: '8px', border: '1px solid #74ec65' }}
    >
      ...
      <Button
        ...
        style={{borderRadius: '8px', background: '#74ec65', color: 'black'}}
      >
      ...
      <Button
        ...
        style={{borderRadius: '8px', border: '1px solid #74ec65', color: 'white'}}
      >
        {t('Cancel')}
      </Button>
    </Modal>
