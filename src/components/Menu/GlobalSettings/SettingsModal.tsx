...
const SettingsModal: React.FC<InjectedModalProps> = ({ onDismiss }) => {
  ...
  return (
    <Modal
      ...
      onDismiss={onDismiss}
      style={{ maxWidth: '420px', borderRadius: '8px', border: '1px solid #74ec65', background: 'black' }}
    >
      <ScrollableContainer>
        <Flex pb="24px" flexDirection="column">
          <Text bold textTransform="uppercase" fontSize="12px" color="rgba(106, 122, 139, 1)" mb="24px">
            {t('Global')}
          </Text>
          <GasSettings />
        </Flex>
